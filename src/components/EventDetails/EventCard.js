...
export const EventCard = (props) => {
  ...
  return (
    <div className="content-container event-card">
      {props.event.userHandle === props.userHandle && (
        <Link to={`../edit/${props.event.id}`}>
      ...
      <div className="event-card__by">
        <div className="event-card__by-name">
          <img src={props.event.userImageUrl} alt="" />{" "}
          <Link to={`../user/${props.event.userHandle}`}>
        ...
        <div className="event-card__by-like">
          {checkLike ? (
            ...
            <button title="like?" className="btn-primary" onClick={onClickLike}>
              <FontAwesomeIcon icon={faHeart} /> {likeCount}
            </button>
          )}
        </div>
      ...
      <div className="event-card__register">
        ...
        {props.userHandle !== props.event.userHandle && (
